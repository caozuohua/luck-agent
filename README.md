...
- **GCP VPS(e2-micro, Free Tier)+Ubuntu**: for hosting.
- **Lark**: for channel.
- **Vertexai/Agent Platform(gemini-2.5-pro/flash/flash-lite)**: for AI.
- **Claude(Free Tier)**: for code design & generation.
