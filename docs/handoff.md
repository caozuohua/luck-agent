...
用户已明确停止新增 Lark API 接入。当前仅维护已上线功能、评估、稳定性和必要修复。
下文 8 月的功能扩展计划保留为历史背景，不再是待执行指令，尤其不继续接入日历、任务或其他 Lark API。
先读 [收尾记录](release-closeout-2026-09-24.md) 和 [历史评估](luck-agent-history-audit-2026-09-24.md)。
生产实际 HEAD 为 `73d94be` 且有多项未提交改动；下文“唯一未提交文件”和旧版本号已过时。
